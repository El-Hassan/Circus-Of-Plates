...
public class Gui extends JPanel implements KeyListener {
	...
	String url1="../circusOfplates2/src/File/player1";
	String url2="../circusOfplates2/src/File/player2";
	...
	public Gui() throws IOException{
		...
		player1=new player("../circusOfplates2/src/images/Superman.png",new Point(1200,600));
		player2=new player("../circusOfplates2/src/images/Batman.png",new Point(100,600));
		 ...
		 public void actionPerformed(ActionEvent e) {
			 ...
			 for(Integer k: pressed)
				{
					...
					if( k == KeyEvent.VK_RIGHT){
						player1.setLocationX(Math.min(
								player1.getLocationX() + 10, getWidth() - 20));
          ...
          // panel.add(reset);
           add(panel);
            ...
            lblNewLabel.setIcon(new ImageIcon("../circusOfplates2/src/images/what-is-my-credit-score-how-is-it-calculated.jpg"));
            lblNewLabel.setBounds(0, 0, 197, 43);
            panel.add(lblNewLabel);
            
            JLabel lblNewLabel_1 = new JLabel("New label");
            lblNewLabel_1.setIcon(new ImageIcon("../circusOfplates2/src/images/what-is-my-credit-score-how-is-it-calculated.jpg"));
	...
	public Dimension getPreferredSize() {
	 ...
	 protected void paintComponent(Graphics g) {
		...
		try {
			img = ImageIO.read(new File("../circusOfplates2/src/images/nuclear_explosion_by_theabp-d59sy3y.gif"));
